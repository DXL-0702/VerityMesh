...
| 层次 | 当前技术栈 | 关键边界 | 当前状态 |
| --- | --- | --- | --- |
| 前端体验层 | Node `24.19.0`、pnpm `10.33.0`、React `19.1.1`、React DOM `19.1.1`、TypeScript `5.9.3`、Vite `7.3.6` | `portal-web`、`assistant-ui` 和 TypeScript Client 共用 pnpm Workspace；React 组件直接作为 Web Component 主实现发布 | 工程基线已冻结 |
