...
当前只建立依赖和可导入包，不包含 Celery Task、Kafka Dispatcher、Alembic Revision 或 Vector Schema。版本总览见 [`技术栈与外部选型总览`](../../docs/technology-selection/technology-selection.md)，本地可执行版本以成员 `pyproject.toml` 和根 `uv.lock` 为准。
