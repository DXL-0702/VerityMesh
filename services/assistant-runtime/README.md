...
当前只建立可安装、可导入和可静态检查的包，不包含 Runtime 路由、Provider Adapter 或 RAG 实现。版本与验证方式见 [`非 Java 工作区工具链基线`](../../docs/implementation-designs/0003-non-java-workspace-toolchain-baseline.md)。
