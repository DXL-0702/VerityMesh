...
| 当前状态 | P1-00/P1-01 最小知识接入基座、本地 MySQL/Flyway Migration Job、S3-compatible Source Storage Adapter 与 Kafka Outbox Publisher 已实现；真实 MySQL 业务连接、Kafka Consumer、身份授权和业务模块仍待集成 |
