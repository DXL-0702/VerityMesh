...
| 当前状态 | P1-00/P1-01 最小知识接入基座与本地 MySQL/Flyway Migration Job 已实现；真实 OSS、MySQL 业务连接、Kafka 和 Outbox Publisher 仍待集成 |
